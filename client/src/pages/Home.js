...
const Home = () => {
    return (
        ...
        >
            ...
            {/* Main Content */}
            <div className="flex flex-col items-center justify-center flex-grow mt-20 px-6">
                ...
                <button className="mt-8 px-8 py-4 bg-white text-[#106EBE] font-semibold rounded-full shadow-md hover:bg-gray-200 transition transform hover:scale-105">
                    View My Work
                </button>
            </div>
        </div>
